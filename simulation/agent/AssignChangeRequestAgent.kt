...
abstract class AssignChangeRequestAgent<SESSION> protected constructor(client: DBClient<SESSION>, context: Context) :
    Agent<Company, SESSION, ModelParams>(client, context) {
    override val agentClass = AssignChangeRequestAgent::class.java
