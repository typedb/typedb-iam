...
abstract class DeleteSubjectAgent<SESSION> protected constructor(client: DBClient<SESSION>, context: Context) :
    Agent<Company, SESSION, ModelParams>(client, context) {
    override val agentClass = DeleteSubjectAgent::class.java
