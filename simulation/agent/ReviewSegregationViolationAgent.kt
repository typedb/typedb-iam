...
abstract class ReviewSegregationViolationAgent<SESSION> protected constructor(client: DBClient<SESSION>, context: Context) :
    Agent<Company, SESSION, ModelParams>(client, context) {
    override val agentClass = ReviewSegregationViolationAgent::class.java
