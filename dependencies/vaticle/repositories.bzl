...
def vaticle_typedb_simulation():
    git_repository(
        ...
        commit = "2049e4d3604cdca4a4f734fcd5fa71dbd8cf6854",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_simulation
    )
